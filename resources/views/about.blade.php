<x-app-layout>
    {{-- main title on page --}}
    <div class="pageMainTitle text-center mt-12">
        <p class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900">About</p>
        <span class="text-lg md:text-xl lg:text-2xl text-gray-600">from True Pasta Lovers</span>
    </div>
    {{-- section about the site --}}
    <div class="max-w-6xl mx-auto px-6 md:px-12 lg:px-20 mt-5 text-center">
        <h2 class="text-2xl md:text-3xl lg:text-2xl font-semibold text-gray-800">About Our Website</h2>
    ...
    <div class="max-w-6xl mx-auto px-6 md:px-12 lg:px-24 mt-5">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            <div class="text-center md:text-left">
                <h2 class="text-2xl md:text-3xl lg:text-2xl font-semibold text-gray-80">The History of Pasta</h2>
                <p class="mt-4 text-md md:text-md text-gray-700 leading-relaxed">
            ...
            <div class="mt-8 md:mt-0">
                <img src="/siteImages/pasta2.jpg" alt="Pasta History" class=" mx-auto rounded-xl shadow-xl">
            </div>
        </div>
    </div>
